...
LANG_STRINGS = {
    ...
    'btn_terms': '📋 OFFICIAL RESELLER TERMS',
    'btn_become_reseller': '💼 Become Reseller',
    'terms_message': '<b>📋 OFFICIAL RESELLER TERMS</b>\n════════════════════\n\n⚠️ IMPORTANT NOTICE:\nContacting us without accepting these terms may result in your message being ignored or blocked.\n\n🚀 BECOME A TOP RESELLER | HSA PANEL\nStep into the fast lane of sales and connect with thousands of customers &amp; stores worldwide.\n\n✨ REQUIREMENTS TO JOIN:\n───────────────────────\n🤝 LOYALTY: Full loyalty to HSA PANEL is mandatory.\n🌐 SUPPORT: Must have active channels to share links and confirm payments.\n📱 KNOWLEDGE: Basic Android skills to handle tools &amp; sales efficiently.\n\n💰 ACTIVATION FEE: $10 🔑\n💡 NOTE: This amount is 100% credited to your account balance for future transactions.\n\n🔥 AFTER ACTIVATION:\n───────────────────────\n✅ Official Reseller verification &amp; listing.\n✅ Access to sell to individual customers.\n✅ Authorization to supply bulk stores.\n✅ Collaboration with approved global resellers.\n\n💎 ACTIVATE NOW &amp; UNLOCK PREMIUM STATUS!\n───────────────────────\nnote only main text in blood font',
        ...
        'language_set_pt': '✅ Brazilian Portuguese selected. Bot messages will appear in Portuguese where available.',
        'btn_back': '🔙 Back',
    ...
    'ar': {
        ...
        'language_set_pt': '✅ تم اختيار البرتغالية البرازيلية. ستظهر رسائل البوت بالبرتغالية عندما تكون متاحة.',
        'btn_back': '🔙 رجوع',
    ...
    'fa': {
        ...
        'no_purchases': 'هنوز خریدی ثبت نشده',
        'welcome': '<b>👋 خوش آمدی {name}</b>',
        'label_user_id': '<b>🆔 شناسه کاربر:</b> <code>{uid}</code>',
        'label_username': '<b>💻 نام کاربری:</b> {username}',
        'label_balance': '<b>💰 موجودی:</b> ${balance}',
        'label_status': '<b>⭐ وضعیت:</b> {status}',
        'label_last_purchase': '<b>🛍️ آخرین خرید:</b> {last_purchase}',
        'menu_intro': '<b>🛒 از فروشنده‌های مورد اعتماد پایین خرید کنید ↓</b>',
        'btn_trusted_seller': '⭐ فروشنده مورد اعتماد',
        'btn_product': '🛍️ محصول',
        'btn_add_balance': '💳 افزایش موجودی',
        'btn_history': '📜 تاریخچه',
        'btn_profile': '👤 پروفایل من',
        'btn_help': '🆘 کمک و پشتیبانی',
        'btn_choose_language': '🌐 انتخاب زبان',
        'btn_terms': '📋 قوانین',
        'btn_become_reseller': '💼 تبدیل به نماینده',
        'terms_message': '<b>📋 قوانین رسمی نمایندگی</b>\n\n<b>⚠️ مهم: تماس بدون پذیرش این قوانین ممکن است باعث نادیده گرفتن پیام یا مسدود شدن شود.</b>\n<b>💼 در HSA PANEL نماینده برتر شوید</b>\n<b>وارد مسیر فروش سریع شوید و با هزاران مشتری و فروشگاه ارتباط بگیرید.</b>\n\n<b>✨ شرایط عضویت:</b>\n<b>• 🤝 وفاداری: وفاداری کامل به HSA PANEL الزامی است.</b>\n<b>• 🌐 پشتیبانی: داشتن کانال فعال برای اشتراک لینک خرید و تایید پرداخت لازم است.</b>\n<b>• 📱 دانش: آشنایی پایه با اپلیکیشن‌های اندروید برای استفاده از ابزارها و مدیریت فروش.</b>\n<b>💰 هزینه فعال‌سازی: $10 🔑</b>\n<b>💡 نکته: این مبلغ به موجودی حساب شما اضافه می‌شود و قابل استفاده در خریدهای بعدی است.</b>\n\n<b>🚀 بعد از فعال‌سازی:</b>\n<b>• 📋 نام شما در لیست رسمی نمایندگان ثبت می‌شود.</b>\n<b>• 👥 فروش به مشتریان شخصی.</b>\n<b>• 🏪 فروش به فروشگاه‌ها.</b>\n<b>• 🤝 همکاری با نمایندگان تاییدشده.</b>\n\n<b>🔥 همین حالا فعال کنید و نماینده ویژه شوید!</b>',
        'choose_language_title': '<b>🌐 انتخاب زبان</b>',
        'choose_language_desc': 'زبان دلخواه ربات را انتخاب کنید.',
        'btn_english': '🇬🇧 انگلیسی',
        'btn_arabic': '🇸🇦 عربی',
        'btn_persian': '🇮🇷 فارسی',
        'btn_hindi': '🇮🇳 هندی',
        ...
        'language_set_pt': '✅ زبان پرتغالی برزیلی انتخاب شد. پیام‌های ربات به پرتغالی در صورت موجود بودن نمایش داده می‌شود.',
        'btn_back': '🔙 بازگشت',
        'btn_back_to_menu': '🔙 بازگشت به منو',
        'btn_back_to_main_menu': '🏠 بازگشت به منوی اصلی',
        'product_title': '<b>🛍️ چه چیزی می‌خواهید؟</b>',
        'product_desc_1': '<b>لطفا یک دسته‌بندی از پایین انتخاب کنید 👇</b>',
        'product_desc_2': '🎮 <b>اکانت:</b> خرید اکانت بازی',
        'product_desc_3': '🔧 <b>هک‌ها:</b> مشاهده ابزارها و پکیج‌های ویژه',
        'btn_account': '🎮 اکانت',
        'btn_hackes': '🔧 هک‌ها',
        'account_title': '<b>🎮 اکانت‌های بازی</b>',
        'account_desc': '<b>نوع اکانت را از پایین انتخاب کنید 👇</b>\nخرید اکانت‌های پریمیوم با کوین و امکانات.',
        'hackes_title': '<b>🔧 دسته‌بندی هک‌ها</b>',
        'hackes_desc': '<b>لطفا یک دسته‌بندی از پایین انتخاب کنید 👇</b>\nبازی خود را انتخاب کنید و ابزارها و پکیج‌های موجود را ببینید.',
        'no_resellers': '❌ نماینده‌ای پیدا نشد.',
        'trusted_sellers_title': '⭐ <b>فروشندگان مورد اعتماد</b>',
        'trusted_sellers_footer': '📞 برای خرید با هر فروشنده تماس بگیرید!',
        'help_title': '<b>🛠 نیاز به کمک دارید؟</b>',
        'help_purchase_error_title': '<b>⚠ خطای خرید</b>',
        'help_purchase_error_body': 'اگر هنگام خرید با خطا مواجه شدید.',
        'help_apk_title': '<b>📦 لینک APK</b>',
        'help_apk_body': 'اگر هک خریدید ولی لینک APK ندارید.',
        'help_any_title': '<b>🆘 هر نوع کمک</b>',
        'help_any_body': 'روی دکمه پایین بزنید تا به پشتیبانی ادمین وصل شوید.',
        'btn_help_short': '🆘 کمک',
        'profile_title': '<b>👤 پروفایل من</b>',
        'profile_name': '<b>👤 نام:</b> {name}',
        'profile_username': '<b>💻 نام کاربری:</b> @{username}',
        'profile_member_since': '<b>📅 عضو از:</b> {date}',
        'btn_purchase_history': '📜 تاریخچه خرید',
        'add_balance_title': '<b>╔════════════════════╗</b>\n<b>   مرکز افزایش موجودی</b>\n<b>╚════════════════════╝</b>',
        'add_balance_1': '<b>می‌خواهید موجودی اضافه کنید 💰</b>',
        'add_balance_2': '<b>شناسه کاربری خود را کپی کنید، سپس روی دکمه واریز بزنید 👇</b>',
        'add_balance_3': '<b>شناسه شما:</b>',
        'add_balance_4': '<b>بعد از پرداخت، اسکرین‌شات را برای ادمین بفرستید.</b>',
        'btn_deposit_now': '💳 واریز الآن',
        'btn_contact_admin': '💬 تماس با ادمین',
        'btn_refresh': '🔄 بروزرسانی',
        'history_empty': 'هیچ تاریخچه خریدی پیدا نشد.',
        'history_title': '<b>🕓 تاریخچه خرید شما:</b>',
        'history_page': '<b>صفحه {page}/{total}</b>',
        'history_product': '<b>📦 محصول:</b> {product}',
        'history_duration': '<b>⏳ مدت:</b> {duration}',
        'history_key': '<b>🔑 کلید:</b> <code>{purchase_key}</code>',
        'history_status_expired': '<b>📅 وضعیت:</b> منقضی ❌',
        'history_status_active': '<b>📅 وضعیت:</b> فعال ✅',
        'history_expired_on': '<i>تاریخ انقضا: {date}</i>',
        'history_expires_on': '<i>منقضی می‌شود در: {date}</i>',
        'btn_previous': '⬅️ قبلی',
        'btn_next': 'بعدی ➡️',
        'confirm_sure': '<b>📝 از خرید مطمئن هستید؟ 🫆</b>',
        'confirm_separator': '<b>--------------------------------------</b>',
        'confirm_note': '<b>لطفا توجه کنید📣:</b>',
        'confirm_no_return': '<b>کلید پس از خرید قابل بازگشت نیست!</b>',
        'confirm_your_balance': '<b>💰 موجودی شما:</b> ${balance}',
        'confirm_price': '<b>💰 قیمت:</b> ${price}',
        'confirm_stock': '<b>📦 موجودی:</b> {stock}',
        'confirm_stock_available': '<b>📦 موجودی: موجود</b>',
        'btn_confirm': '✅ تایید',
        'btn_cancel': '❌ لغو',
        'out_of_stock_title': '❌ محصول ناموجود است',
        'out_of_stock_product': '🐍 محصول: {product}',
        'out_of_stock_duration': '⏳ مدت: {duration}',
        'out_of_stock_footer': '📦 موجودی فعلی: 0\n\nلطفا بعدا دوباره تلاش کنید.',
        'not_vip_msg': '❌ شما VIP نیستید. قیمت‌ها فقط برای کاربران VIP نمایش داده می‌شود.',
        'unknown_product': 'محصول ناشناخته.',
        'out_of_stock_error': '❌ متاسفیم، محصول ناموجود شد.',
        'insufficient_balance_title': '❌ موجودی کافی نیست',
        'insufficient_balance_body': 'موجودی شما برای تکمیل این خرید کافی نیست.\n\nلطفا حساب خود را شارژ کرده و دوباره تلاش کنید.',
        'success_title': '<b>✅ خرید با موفقیت انجام شد!</b>',
        'success_product': '<b>📦 محصول:</b> {product}',
        'success_duration': '<b>⏳ مدت:</b> {duration}',
        'success_remaining': '<b>💰 موجودی باقی‌مانده:</b> {balance}$',
        'success_key': '<b>🔑 کلید شما:</b> <code>{purchase_key}</code>',
        'success_enjoy': '<b>از دسترسی ویژه خود لذت ببرید 🚀</b>',
        'account_not_available_title': '❌ اکانت موجود نیست',
        'account_not_available_body': 'متاسفیم، فعلا هیچ اکانتی موجود نیست.\nلطفا با ادمین تماس بگیرید یا بعدا تلاش کنید.',
        'success_8bp_product': '🎱 <b>محصول:</b> {product}',
        'success_8bp_price': '💰 <b>قیمت:</b> ${price}',
        'success_8bp_remaining': '💳 <b>موجودی باقی‌مانده:</b> ${balance}',
        'success_8bp_account_header': '          ✓ <b>جزئیات اکانت</b>',
        'success_8bp_gmail': '📥 <b>جیمیل:</b> {gmail}',
        'success_8bp_password': '🔐 <b>رمز عبور:</b> {password}',
        'insuf_price': '💰 <b>قیمت:</b> ${price}',
        'insuf_your_balance': '💳 <b>موجودی شما:</b> ${balance}',
        'insuf_shortfall': '📊 <b>کسری:</b> ${shortfall}',
        'insuf_footer': 'لطفا موجودی حساب خود را افزایش دهید.',
    },
    'hi': {
        'status_vip': '🌟 VIP',
        'status_active': '🔓 सक्रिय',
        'no_username': 'यूज़रनेम नहीं है',
        'no_purchases': 'अभी तक कोई खरीद नहीं',
        'welcome': '<b>👋 स्वागत है {name}</b>',
        'label_user_id': '<b>🆔 यूज़र आईडी:</b> <code>{uid}</code>',
        'label_username': '<b>💻 यूज़रनेम:</b> {username}',
        'label_balance': '<b>💰 बैलेंस:</b> ${balance}',
        'label_status': '<b>⭐ स्टेटस:</b> {status}',
        'label_last_purchase': '<b>🛍️ अंतिम खरीद:</b> {last_purchase}',
        'menu_intro': '<b>🛒 नीचे दिए गए ट्रस्टेड सेलर्स से खरीदारी करें ↓</b>',
        'btn_trusted_seller': '⭐ ट्रस्टेड सेलर',
        'btn_product': '🛍️ प्रोडक्ट',
        'btn_add_balance': '💳 बैलेंस जोड़ें',
        'btn_history': '📜 हिस्ट्री',
        'btn_profile': '👤 मेरी प्रोफाइल',
        'btn_help': '🆘 मदद और सपोर्ट',
        'btn_choose_language': '🌐 भाषा चुनें',
        'btn_terms': '📋 नियम',
        'btn_become_reseller': '💼 रीसेलर बनें',
        'terms_message': '<b>📋 आधिकारिक रीसेलर नियम</b>\n\n<b>⚠️ महत्वपूर्ण: इन नियमों को स्वीकार किए बिना संपर्क करने पर संदेश अनदेखा या ब्लॉक हो सकता है।</b>\n<b>💼 HSA PANEL पर टॉप रीसेलर बनें</b>\n<b>तेज़ बिक्री की दुनिया में आएं और हजारों ग्राहकों व स्टोर्स से जुड़ें।</b>\n\n<b>✨ जुड़ने की शर्तें:</b>\n<b>• 🤝 निष्ठा: HSA PANEL के प्रति पूर्ण निष्ठा जरूरी है।</b>\n<b>• 🌐 सपोर्ट: खरीद लिंक शेयर करने और पेमेंट कन्फर्म करने के लिए सक्रिय चैनल होना चाहिए।</b>\n<b>• 📱 जानकारी: टूल्स और बिक्री संभालने के लिए बेसिक एंड्रॉइड ऐप ज्ञान।</b>\n<b>💰 एक्टिवेशन फीस: $10 🔑</b>\n<b>💡 नोट: यह राशि आपके बैलेंस में जुड़ती है और आगे लेनदेन में उपयोग हो सकती है।</b>\n\n<b>🚀 एक्टिवेशन के बाद:</b>\n<b>• 📋 आपका नाम आधिकारिक रीसेलर सूची में जोड़ा जाएगा।</b>\n<b>• 👥 व्यक्तिगत ग्राहकों को बेचें।</b>\n<b>• 🏪 स्टोर्स को बेचें।</b>\n<b>• 🤝 अनुमोदित रीसेलर्स के साथ काम करें।</b>\n\n<b>🔥 अभी एक्टिवेट करें और प्रीमियम रीसेलर स्टेटस पाएं!</b>',
        'choose_language_title': '<b>🌐 भाषा चुनें</b>',
        'choose_language_desc': 'अपनी पसंदीदा बॉट भाषा चुनें।',
        'btn_english': '🇬🇧 इंग्लिश',
        'btn_arabic': '🇸🇦 अरबी',
        'btn_persian': '🇮🇷 फ़ारसी',
        'btn_hindi': '🇮🇳 हिंदी',
        ...
        'language_set_pt': '✅ ब्राज़ीलियन पुर्तगाली चुनी गई। बॉट संदेश उपलब्ध होने पर पुर्तगाली में दिखेंगे।',
        'btn_back': '🔙 वापस',
        'btn_back_to_menu': '🔙 मेनू पर वापस',
        'btn_back_to_main_menu': '🏠 मुख्य मेनू पर वापस',
        'product_title': '<b>🛍️ आप क्या चाहते हैं?</b>',
        'product_desc_1': '<b>कृपया नीचे से एक कैटेगरी चुनें 👇</b>',
        'product_desc_2': '🎮 <b>अकाउंट:</b> गेम अकाउंट खरीदें',
        'product_desc_3': '🔧 <b>हैक्स:</b> प्रीमियम टूल्स और पैकेज देखें',
        'btn_account': '🎮 अकाउंट',
        'btn_hackes': '🔧 हैक्स',
        'account_title': '<b>🎮 गेम अकाउंट्स</b>',
        'account_desc': '<b>नीचे से अपना अकाउंट टाइप चुनें 👇</b>\nकॉइन और फीचर्स के साथ प्रीमियम गेम अकाउंट खरीदें।',
        'hackes_title': '<b>🔧 हैक्स कैटेगरी</b>',
        'hackes_desc': '<b>कृपया नीचे से एक कैटेगरी चुनें 👇</b>\nअपना गेम चुनें और उपलब्ध टूल्स व प्रीमियम पैकेज देखें।',
        'no_resellers': '❌ कोई रीसेलर नहीं मिला।',
        'trusted_sellers_title': '⭐ <b>ट्रस्टेड सेलर्स</b>',
        'trusted_sellers_footer': '📞 खरीदारी के लिए किसी भी सेलर से संपर्क करें!',
        'help_title': '<b>🛠 मदद चाहिए?</b>',
        'help_purchase_error_title': '<b>⚠ खरीद त्रुटि</b>',
        'help_purchase_error_body': 'अगर खरीदारी के दौरान कोई त्रुटि आ रही हो।',
        'help_apk_title': '<b>📦 APK लिंक</b>',
        'help_apk_body': 'अगर आपने कोई हैक खरीदा है लेकिन APK लिंक नहीं है।',
        'help_any_title': '<b>🆘 किसी भी प्रकार की मदद</b>',
        'help_any_body': 'एडमिन सपोर्ट से जुड़ने के लिए नीचे बटन दबाएं।',
        'btn_help_short': '🆘 मदद',
        'profile_title': '<b>👤 मेरी प्रोफाइल</b>',
        'profile_name': '<b>👤 नाम:</b> {name}',
        'profile_username': '<b>💻 यूज़रनेम:</b> @{username}',
        'profile_member_since': '<b>📅 सदस्यता तिथि:</b> {date}',
        'btn_purchase_history': '📜 खरीद इतिहास',
        'add_balance_title': '<b>╔════════════════════╗</b>\n<b>   बैलेंस ऐड सेंटर</b>\n<b>╚════════════════════╝</b>',
        'add_balance_1': '<b>बैलेंस जोड़ना चाहते हैं 💰</b>',
        'add_balance_2': '<b>अपनी यूज़र आईडी कॉपी करें, फिर नीचे डिपॉजिट बटन दबाएं 👇</b>',
        'add_balance_3': '<b>आपकी आईडी:</b>',
        'add_balance_4': '<b>पेमेंट के बाद स्क्रीनशॉट एडमिन को भेजें।</b>',
        'btn_deposit_now': '💳 अभी डिपॉजिट करें',
        'btn_contact_admin': '💬 एडमिन से संपर्क',
        'btn_refresh': '🔄 रिफ्रेश',
        'history_empty': 'कोई खरीद इतिहास नहीं मिला।',
        'history_title': '<b>🕓 आपका खरीद इतिहास:</b>',
        'history_page': '<b>पेज {page}/{total}</b>',
        'history_product': '<b>📦 प्रोडक्ट:</b> {product}',
        'history_duration': '<b>⏳ अवधि:</b> {duration}',
        'history_key': '<b>🔑 की:</b> <code>{purchase_key}</code>',
        'history_status_expired': '<b>📅 स्थिति:</b> समाप्त ❌',
        'history_status_active': '<b>📅 स्थिति:</b> सक्रिय ✅',
        'history_expired_on': '<i>समाप्ति तिथि: {date}</i>',
        'history_expires_on': '<i>समाप्त होगा: {date}</i>',
        'btn_previous': '⬅️ पिछला',
        'btn_next': 'अगला ➡️',
        'confirm_sure': '<b>📝 क्या आप खरीद के लिए पक्का हैं? 🫆</b>',
        'confirm_separator': '<b>--------------------------------------</b>',
        'confirm_note': '<b>कृपया ध्यान दें📣:</b>',
        'confirm_no_return': '<b>खरीद के बाद की वापस नहीं की जा सकती!</b>',
        'confirm_your_balance': '<b>💰 आपका बैलेंस:</b> ${balance}',
        'confirm_price': '<b>💰 कीमत:</b> ${price}',
        'confirm_stock': '<b>📦 स्टॉक:</b> {stock}',
        'confirm_stock_available': '<b>📦 स्टॉक: उपलब्ध</b>',
        'btn_confirm': '✅ कन्फर्म',
        'btn_cancel': '❌ रद्द करें',
        'out_of_stock_title': '❌ प्रोडक्ट आउट ऑफ स्टॉक',
        'out_of_stock_product': '🐍 प्रोडक्ट: {product}',
        'out_of_stock_duration': '⏳ अवधि: {duration}',
        'out_of_stock_footer': '📦 उपलब्ध स्टॉक: 0\n\nकृपया बाद में फिर प्रयास करें।',
        'not_vip_msg': '❌ आप VIP नहीं हैं। कीमतें केवल VIP यूज़र्स को दिखती हैं।',
        'unknown_product': 'अज्ञात प्रोडक्ट।',
        'out_of_stock_error': '❌ माफ़ करें, प्रोडक्ट स्टॉक से बाहर हो गया।',
        'insufficient_balance_title': '❌ बैलेंस अपर्याप्त',
        'insufficient_balance_body': 'इस खरीद को पूरा करने के लिए आपका बैलेंस कम है।\n\nकृपया बैलेंस जोड़कर फिर कोशिश करें।',
        'success_title': '<b>✅ खरीद सफल!</b>',
        'success_product': '<b>📦 प्रोडक्ट:</b> {product}',
        'success_duration': '<b>⏳ अवधि:</b> {duration}',
        'success_remaining': '<b>💰 बचा हुआ बैलेंस:</b> {balance}$',
        'success_key': '<b>🔑 आपकी की:</b> <code>{purchase_key}</code>',
        'success_enjoy': '<b>अपना प्रीमियम एक्सेस एंजॉय करें 🚀</b>',
        'account_not_available_title': '❌ अकाउंट उपलब्ध नहीं',
        'account_not_available_body': 'माफ़ करें, फिलहाल कोई अकाउंट उपलब्ध नहीं है।\nकृपया एडमिन से संपर्क करें या बाद में प्रयास करें।',
        'success_8bp_product': '🎱 <b>प्रोडक्ट:</b> {product}',
        'success_8bp_price': '💰 <b>कीमत:</b> ${price}',
        'success_8bp_remaining': '💳 <b>बचा हुआ बैलेंस:</b> ${balance}',
        'success_8bp_account_header': '          ✓ <b>अकाउंट विवरण</b>',
        'success_8bp_gmail': '📥 <b>Gmail:</b> {gmail}',
        'success_8bp_password': '🔐 <b>पासवर्ड:</b> {password}',
        'insuf_price': '💰 <b>कीमत:</b> ${price}',
    ...
    'es': {
        ...
        'no_purchases': 'Aun no hay compras',
        'welcome': '<b>👋 Bienvenido {name}</b>',
        'label_user_id': '<b>🆔 ID de usuario:</b> <code>{uid}</code>',
        'label_username': '<b>💻 Usuario:</b> {username}',
        'label_balance': '<b>💰 Saldo:</b> ${balance}',
        'label_status': '<b>⭐ Estado:</b> {status}',
        'label_last_purchase': '<b>🛍️ Ultima compra:</b> {last_purchase}',
        'menu_intro': '<b>🛒 Compra con vendedores confiables abajo ↓</b>',
        'btn_trusted_seller': '⭐ Vendedor confiable',
        'btn_product': '🛍️ Producto',
        'btn_add_balance': '💳 Agregar saldo',
        'btn_history': '📜 Historial',
        'btn_profile': '👤 Mi perfil',
        'btn_help': '🆘 Ayuda y soporte',
        'btn_choose_language': '🌐 Elegir idioma',
        'btn_terms': '📋 Terminos',
        'btn_become_reseller': '💼 Ser revendedor',
        'terms_message': '<b>📋 Terminos oficiales de revendedor</b>\n\n<b>⚠️ Importante: Contactarnos sin aceptar estos terminos puede causar que tu mensaje sea ignorado o bloqueado.</b>\n<b>💼 Conviertete en un revendedor top en HSA PANEL</b>\n<b>Entra al carril rapido de ventas y conecta con miles de clientes y tiendas.</b>\n\n<b>✨ Requisitos para unirte:</b>\n<b>• 🤝 Lealtad: Se requiere lealtad total a HSA PANEL.</b>\n<b>• 🌐 Soporte: Debes tener canales activos para compartir enlaces de compra y confirmar pagos.</b>\n<b>• 📱 Conocimiento: Habilidades basicas de apps Android para usar herramientas y manejar ventas.</b>\n<b>💰 Cuota de activacion: $10 🔑</b>\n<b>💡 Nota: Este monto se acredita a tu saldo y puedes usarlo en futuras transacciones.</b>\n\n<b>🚀 Despues de la activacion:</b>\n<b>• 📋 Tu nombre aparece en la lista oficial de revendedores.</b>\n<b>• 👥 Vende a clientes individuales.</b>\n<b>• 🏪 Vende a tiendas.</b>\n<b>• 🤝 Colabora con revendedores aprobados.</b>\n\n<b>🔥 Activa ahora y desbloquea estado premium de revendedor!</b>',
        'choose_language_title': '<b>🌐 Elegir idioma</b>',
        'choose_language_desc': 'Selecciona el idioma preferido del bot.',
        'btn_english': '🇬🇧 Ingles',
        'btn_arabic': '🇸🇦 Arabe',
        'btn_persian': '🇮🇷 Persa',
        'btn_hindi': '🇮🇳 Hindi',
        ...
        'btn_brazilian': '🇧🇷 Brasileno',
        'language_set_en': '✅ Ingles seleccionado. (Idioma por defecto)',
        'language_set_ar': '✅ Arabe seleccionado. Los mensajes se mostraran en arabe.',
        'language_set_fa': '✅ Persa seleccionado. Los mensajes se mostraran en persa.',
        'language_set_hi': '✅ Hindi seleccionado. Los mensajes se mostraran en hindi.',
        'language_set_es': '✅ Espanol colombiano seleccionado. Los mensajes se mostraran en espanol.',
        'language_set_id': '✅ Indonesio seleccionado. Los mensajes se mostraran en indonesio.',
        'language_set_pt': '✅ Portugues brasileno seleccionado. Los mensajes se mostraran en portugues.',
        'btn_back': '🔙 Atras',
        'btn_back_to_menu': '🔙 Volver al menu',
        'btn_back_to_main_menu': '🏠 Volver al menu principal',
        'product_title': '<b>🛍️ Que deseas?</b>',
        'product_desc_1': '<b>Selecciona una categoria abajo 👇</b>',
        'product_desc_2': '🎮 <b>Cuenta:</b> Comprar cuentas de juego',
        'product_desc_3': '🔧 <b>Hacks:</b> Ver herramientas y paquetes premium',
        'btn_account': '🎮 Cuenta',
        'btn_hackes': '🔧 Hacks',
        'account_title': '<b>🎮 Cuentas de juego</b>',
        'account_desc': '<b>Elige el tipo de cuenta abajo 👇</b>\nCompra cuentas premium con monedas y funciones.',
        'hackes_title': '<b>🔧 Categorias de hacks</b>',
        'hackes_desc': '<b>Selecciona una categoria abajo 👇</b>\nElige tu juego y explora herramientas y paquetes premium.',
        'no_resellers': '❌ No se encontro revendedor.',
        'trusted_sellers_title': '⭐ <b>Vendedores confiables</b>',
        'trusted_sellers_footer': '📞 Contacta cualquier vendedor para comprar!',
        'help_title': '<b>🛠 Necesitas ayuda?</b>',
        'help_purchase_error_title': '<b>⚠ Error de compra</b>',
        'help_purchase_error_body': 'Si tienes algun error durante la compra.',
        'help_apk_title': '<b>📦 Enlace APK</b>',
        'help_apk_body': 'Si compraste un hack pero no tienes enlace APK.',
        'help_any_title': '<b>🆘 Cualquier tipo de ayuda</b>',
        'help_any_body': 'Pulsa el boton de abajo para contactar soporte del admin.',
        'btn_help_short': '🆘 Ayuda',
        'profile_title': '<b>👤 Mi perfil</b>',
        'profile_name': '<b>👤 Nombre:</b> {name}',
        'profile_username': '<b>💻 Usuario:</b> @{username}',
        'profile_member_since': '<b>📅 Miembro desde:</b> {date}',
        'btn_purchase_history': '📜 Historial de compras',
        'add_balance_title': '<b>╔════════════════════╗</b>\n<b>   CENTRO DE SALDO</b>\n<b>╚════════════════════╝</b>',
        'add_balance_1': '<b>Quieres agregar saldo 💰</b>',
        'add_balance_2': '<b>Copia tu ID de usuario y toca Depositar abajo 👇</b>',
        'add_balance_3': '<b>Tu ID:</b>',
        'add_balance_4': '<b>Despues del pago, envia captura al admin.</b>',
        'btn_deposit_now': '💳 Depositar ahora',
        'btn_contact_admin': '💬 Contactar admin',
        'btn_refresh': '🔄 Actualizar',
        'history_empty': 'No se encontro historial de compras.',
        'history_title': '<b>🕓 Tu historial de compras:</b>',
        'history_page': '<b>Pagina {page}/{total}</b>',
        'history_product': '<b>📦 Producto:</b> {product}',
        'history_duration': '<b>⏳ Duracion:</b> {duration}',
        'history_key': '<b>🔑 Clave:</b> <code>{purchase_key}</code>',
        'history_status_expired': '<b>📅 Estado:</b> Expirado ❌',
        'history_status_active': '<b>📅 Estado:</b> Activo ✅',
        'history_expired_on': '<i>Expiro el: {date}</i>',
        'history_expires_on': '<i>Expira el: {date}</i>',
        'btn_previous': '⬅️ Anterior',
        'btn_next': 'Siguiente ➡️',
        'confirm_sure': '<b>📝 Seguro que deseas comprar? 🫆</b>',
        'confirm_separator': '<b>--------------------------------------</b>',
        'confirm_note': '<b>Por favor nota📣:</b>',
        'confirm_no_return': '<b>La clave no se puede devolver despues de comprar!</b>',
        'confirm_your_balance': '<b>💰 Tu saldo:</b> ${balance}',
        'confirm_price': '<b>💰 Precio:</b> ${price}',
        'confirm_stock': '<b>📦 Stock:</b> {stock}',
        'confirm_stock_available': '<b>📦 Stock: Disponible</b>',
        'btn_confirm': '✅ Confirmar',
        'btn_cancel': '❌ Cancelar',
        'out_of_stock_title': '❌ Producto sin stock',
        'out_of_stock_product': '🐍 Producto: {product}',
        'out_of_stock_duration': '⏳ Duracion: {duration}',
        'out_of_stock_footer': '📦 Stock disponible: 0\n\nIntentalo de nuevo mas tarde.',
        'not_vip_msg': '❌ No eres VIP. Los precios solo son visibles para usuarios VIP.',
        'unknown_product': 'Producto desconocido.',
        'out_of_stock_error': '❌ Lo sentimos, el producto se quedo sin stock.',
        'insufficient_balance_title': '❌ Saldo insuficiente',
        'insufficient_balance_body': 'Tu saldo es muy bajo para completar esta compra.\n\nAgrega fondos e intentalo de nuevo.',
        'success_title': '<b>✅ Compra exitosa!</b>',
        'success_product': '<b>📦 Producto:</b> {product}',
        'success_duration': '<b>⏳ Duracion:</b> {duration}',
        'success_remaining': '<b>💰 Saldo restante:</b> {balance}$',
        'success_key': '<b>🔑 Tu clave:</b> <code>{purchase_key}</code>',
        'success_enjoy': '<b>Disfruta tu acceso premium 🚀</b>',
        'account_not_available_title': '❌ Cuenta no disponible',
        'account_not_available_body': 'Lo sentimos, no hay cuentas disponibles en este momento.\nContacta al admin o intenta mas tarde.',
        'success_8bp_product': '🎱 <b>Producto:</b> {product}',
        'success_8bp_price': '💰 <b>Precio:</b> ${price}',
        'success_8bp_remaining': '💳 <b>Saldo restante:</b> ${balance}',
        'success_8bp_account_header': '          ✓ <b>Detalles de la cuenta</b>',
        'success_8bp_gmail': '📥 <b>Gmail:</b> {gmail}',
        'success_8bp_password': '🔐 <b>Contrasena:</b> {password}',
        'insuf_price': '💰 <b>Precio:</b> ${price}',
        'insuf_your_balance': '💳 <b>Tu saldo:</b> ${balance}',
        'insuf_shortfall': '📊 <b>Faltante:</b> ${shortfall}',
        'insuf_footer': 'Agrega saldo a tu cuenta.',
    },
    'id': {
        'status_vip': '🌟 VIP',
        'status_active': '🔓 Aktif',
        'no_username': 'Tanpa username',
        'no_purchases': 'Belum ada pembelian',
        'welcome': '<b>👋 Selamat datang {name}</b>',
        'label_user_id': '<b>🆔 ID pengguna:</b> <code>{uid}</code>',
        'label_username': '<b>💻 Username:</b> {username}',
        'label_balance': '<b>💰 Saldo:</b> ${balance}',
        'label_status': '<b>⭐ Status:</b> {status}',
        'label_last_purchase': '<b>🛍️ Pembelian terakhir:</b> {last_purchase}',
        'menu_intro': '<b>🛒 Belanja dari penjual terpercaya di bawah ↓</b>',
        'btn_trusted_seller': '⭐ Penjual terpercaya',
        'btn_product': '🛍️ Produk',
        'btn_add_balance': '💳 Tambah saldo',
        'btn_history': '📜 Riwayat',
        'btn_profile': '👤 Profil saya',
        'btn_help': '🆘 Bantuan & dukungan',
        'btn_choose_language': '🌐 Pilih bahasa',
        'btn_terms': '📋 Syarat',
        'btn_become_reseller': '💼 Jadi reseller',
        'terms_message': '<b>📋 Syarat resmi reseller</b>\n\n<b>⚠️ Penting: Menghubungi kami tanpa menyetujui syarat ini dapat membuat pesan diabaikan atau diblokir.</b>\n<b>💼 Jadi reseller top di HSA PANEL</b>\n<b>Masuk ke jalur cepat penjualan dan terhubung dengan ribuan pelanggan & toko.</b>\n\n<b>✨ Syarat bergabung:</b>\n<b>• 🤝 Loyalitas: Loyalitas penuh ke HSA PANEL wajib.</b>\n<b>• 🌐 Dukungan: Harus punya channel aktif untuk share link pembelian dan konfirmasi pembayaran.</b>\n<b>• 📱 Pengetahuan: Dasar aplikasi Android untuk memakai tools dan mengelola penjualan.</b>\n<b>💰 Biaya aktivasi: $10 🔑</b>\n<b>💡 Catatan: Jumlah ini masuk ke saldo akun dan bisa dipakai transaksi berikutnya.</b>\n\n<b>🚀 Setelah aktivasi:</b>\n<b>• 📋 Nama kamu masuk daftar resmi reseller.</b>\n<b>• 👥 Jual ke pelanggan individu.</b>\n<b>• 🏪 Jual ke toko.</b>\n<b>• 🤝 Kolaborasi dengan reseller yang disetujui.</b>\n\n<b>🔥 Aktifkan sekarang dan buka status reseller premium!</b>',
        ...
        'btn_brazilian': '🇧🇷 Brasil',
        'language_set_en': '✅ Bahasa Inggris dipilih. (Default)',
        'language_set_ar': '✅ Bahasa Arab dipilih. Pesan bot akan tampil dalam bahasa Arab.',
        'language_set_fa': '✅ Bahasa Persia dipilih. Pesan bot akan tampil dalam bahasa Persia.',
        'language_set_hi': '✅ Bahasa Hindi dipilih. Pesan bot akan tampil dalam bahasa Hindi.',
        'language_set_es': '✅ Bahasa Spanyol Kolombia dipilih. Pesan bot akan tampil dalam bahasa Spanyol.',
        'language_set_id': '✅ Bahasa Indonesia dipilih. Pesan bot akan tampil dalam bahasa Indonesia.',
        'language_set_pt': '✅ Bahasa Portugis Brasil dipilih. Pesan bot akan tampil dalam bahasa Portugis.',
        'btn_back': '🔙 Kembali',
        'btn_back_to_menu': '🔙 Kembali ke menu',
        'btn_back_to_main_menu': '🏠 Kembali ke menu utama',
        'product_title': '<b>🛍️ Kamu mau apa?</b>',
        'product_desc_1': '<b>Silakan pilih kategori di bawah 👇</b>',
        'product_desc_2': '🎮 <b>Akun:</b> Beli akun game',
        'product_desc_3': '🔧 <b>Hack:</b> Lihat tools dan paket premium',
        'btn_account': '🎮 Akun',
        'btn_hackes': '🔧 Hack',
        'account_title': '<b>🎮 Akun game</b>',
        'account_desc': '<b>Pilih tipe akun di bawah 👇</b>\nBeli akun game premium dengan coin dan fitur.',
        'hackes_title': '<b>🔧 Kategori hack</b>',
        'hackes_desc': '<b>Silakan pilih kategori di bawah 👇</b>\nPilih game kamu dan lihat tools serta paket premium.',
        'no_resellers': '❌ Tidak ada reseller ditemukan.',
        'trusted_sellers_title': '⭐ <b>Penjual terpercaya</b>',
        'trusted_sellers_footer': '📞 Hubungi salah satu penjual untuk membeli!',
        'help_title': '<b>🛠 Butuh bantuan?</b>',
        'help_purchase_error_title': '<b>⚠ Error pembelian</b>',
        'help_purchase_error_body': 'Jika kamu mengalami error saat pembelian.',
        'help_apk_title': '<b>📦 Link APK</b>',
        'help_apk_body': 'Jika kamu sudah beli hack tapi tidak punya link APK.',
        'help_any_title': '<b>🆘 Semua jenis bantuan</b>',
        'help_any_body': 'Klik tombol di bawah untuk terhubung ke dukungan admin.',
        'btn_help_short': '🆘 Bantuan',
        'profile_title': '<b>👤 Profil saya</b>',
        'profile_name': '<b>👤 Nama:</b> {name}',
        'profile_username': '<b>💻 Username:</b> @{username}',
        'profile_member_since': '<b>📅 Member sejak:</b> {date}',
        'btn_purchase_history': '📜 Riwayat pembelian',
        'add_balance_title': '<b>╔════════════════════╗</b>\n<b>   PUSAT TAMBAH SALDO</b>\n<b>╚════════════════════╝</b>',
        'add_balance_1': '<b>Mau tambah saldo 💰</b>',
        'add_balance_2': '<b>Salin ID pengguna kamu, lalu tekan tombol Deposit di bawah 👇</b>',
        'add_balance_3': '<b>ID kamu:</b>',
        'add_balance_4': '<b>Setelah bayar, kirim screenshot ke admin.</b>',
        'btn_deposit_now': '💳 Deposit sekarang',
        'btn_contact_admin': '💬 Hubungi admin',
        'btn_refresh': '🔄 Refresh',
        'history_empty': 'Tidak ada riwayat pembelian.',
        'history_title': '<b>🕓 Riwayat pembelian kamu:</b>',
        'history_page': '<b>Halaman {page}/{total}</b>',
        'history_product': '<b>📦 Produk:</b> {product}',
        'history_duration': '<b>⏳ Durasi:</b> {duration}',
        'history_key': '<b>🔑 Key:</b> <code>{purchase_key}</code>',
        'history_status_expired': '<b>📅 Status:</b> Kadaluarsa ❌',
        'history_status_active': '<b>📅 Status:</b> Aktif ✅',
        'history_expired_on': '<i>Kadaluarsa pada: {date}</i>',
        'history_expires_on': '<i>Berakhir pada: {date}</i>',
        'btn_previous': '⬅️ Sebelumnya',
        'btn_next': 'Berikutnya ➡️',
        'confirm_sure': '<b>📝 Yakin ingin membeli? 🫆</b>',
        'confirm_separator': '<b>--------------------------------------</b>',
        'confirm_note': '<b>Perhatian📣:</b>',
        'confirm_no_return': '<b>Key tidak bisa dikembalikan setelah pembelian!</b>',
        'confirm_your_balance': '<b>💰 Saldo kamu:</b> ${balance}',
        'confirm_price': '<b>💰 Harga:</b> ${price}',
        'confirm_stock': '<b>📦 Stok:</b> {stock}',
        'confirm_stock_available': '<b>📦 Stok: Tersedia</b>',
        'btn_confirm': '✅ Konfirmasi',
        'btn_cancel': '❌ Batal',
        'out_of_stock_title': '❌ Produk habis',
        'out_of_stock_product': '🐍 Produk: {product}',
        'out_of_stock_duration': '⏳ Durasi: {duration}',
        'out_of_stock_footer': '📦 Stok tersedia: 0\n\nSilakan coba lagi nanti.',
        'not_vip_msg': '❌ Kamu bukan VIP. Harga hanya terlihat untuk pengguna VIP.',
        'unknown_product': 'Produk tidak dikenal.',
        'out_of_stock_error': '❌ Maaf, produk sudah habis.',
        'insufficient_balance_title': '❌ Saldo tidak cukup',
        'insufficient_balance_body': 'Saldo kamu terlalu rendah untuk menyelesaikan pembelian ini.\n\nSilakan tambah saldo dan coba lagi.',
        'success_title': '<b>✅ Pembelian berhasil!</b>',
        'success_product': '<b>📦 Produk:</b> {product}',
        'success_duration': '<b>⏳ Durasi:</b> {duration}',
        'success_remaining': '<b>💰 Sisa saldo:</b> {balance}$',
        'success_key': '<b>🔑 Key kamu:</b> <code>{purchase_key}</code>',
        'success_enjoy': '<b>Nikmati akses premium kamu 🚀</b>',
        'account_not_available_title': '❌ Akun tidak tersedia',
        'account_not_available_body': 'Maaf, tidak ada akun tersedia saat ini.\nSilakan hubungi admin atau coba lagi nanti.',
        'success_8bp_product': '🎱 <b>Produk:</b> {product}',
        'success_8bp_price': '💰 <b>Harga:</b> ${price}',
        'success_8bp_remaining': '💳 <b>Sisa saldo:</b> ${balance}',
        'success_8bp_account_header': '          ✓ <b>Detail akun</b>',
        'success_8bp_gmail': '📥 <b>Gmail:</b> {gmail}',
        'success_8bp_password': '🔐 <b>Password:</b> {password}',
        'insuf_price': '💰 <b>Harga:</b> ${price}',
        'insuf_your_balance': '💳 <b>Saldo kamu:</b> ${balance}',
        'insuf_shortfall': '📊 <b>Kekurangan:</b> ${shortfall}',
        'insuf_footer': 'Silakan tambah saldo ke akun kamu.',
    },
    'pt': {
        'status_vip': '🌟 VIP',
        'status_active': '🔓 Ativo',
        'no_username': 'Sem nome de usuario',
        'no_purchases': 'Ainda sem compras',
        'welcome': '<b>👋 Bem-vindo {name}</b>',
        'label_user_id': '<b>🆔 ID do usuario:</b> <code>{uid}</code>',
        'label_username': '<b>💻 Usuario:</b> {username}',
        'label_balance': '<b>💰 Saldo:</b> ${balance}',
        'label_status': '<b>⭐ Status:</b> {status}',
        'label_last_purchase': '<b>🛍️ Ultima compra:</b> {last_purchase}',
        'menu_intro': '<b>🛒 Compre com vendedores confiaveis abaixo ↓</b>',
        'btn_trusted_seller': '⭐ Vendedor confiavel',
        'btn_product': '🛍️ Produto',
        'btn_add_balance': '💳 Adicionar saldo',
        'btn_history': '📜 Historico',
        'btn_profile': '👤 Meu perfil',
        'btn_help': '🆘 Ajuda e suporte',
        'btn_choose_language': '🌐 Escolher idioma',
        'btn_terms': '📋 Termos',
        'btn_become_reseller': '💼 Virar revendedor',
        'terms_message': '<b>📋 Termos oficiais de revendedor</b>\n\n<b>⚠️ Importante: Falar com a gente sem aceitar estes termos pode resultar em mensagens ignoradas ou bloqueadas.</b>\n<b>💼 Torne-se um revendedor top no HSA PANEL</b>\n<b>Entre na via rapida de vendas e conecte com milhares de clientes e lojas.</b>\n\n<b>✨ Requisitos para entrar:</b>\n<b>• 🤝 Lealdade: Lealdade total ao HSA PANEL e obrigatoria.</b>\n<b>• 🌐 Suporte: Deve ter canais ativos para compartilhar links e confirmar pagamentos.</b>\n<b>• 📱 Conhecimento: Nocao basica de apps Android para usar as ferramentas e vender bem.</b>\n<b>💰 Taxa de ativacao: $10 🔑</b>\n<b>💡 Nota: Esse valor vai para seu saldo e pode ser usado nas proximas transacoes.</b>\n\n<b>🚀 Depois da ativacao:</b>\n<b>• 📋 Seu nome entra na lista oficial de revendedores.</b>\n<b>• 👥 Venda para clientes individuais.</b>\n<b>• 🏪 Venda para lojas.</b>\n<b>• 🤝 Colabore com revendedores aprovados.</b>\n\n<b>🔥 Ative agora e desbloqueie status premium de revendedor!</b>',
        'choose_language_title': '<b>🌐 Escolher idioma</b>',
        'choose_language_desc': 'Selecione seu idioma preferido do bot.',
        'btn_english': '🇬🇧 Ingles',
        'btn_arabic': '🇸🇦 Arabe',
        'btn_persian': '🇮🇷 Persa',
        'btn_hindi': '🇮🇳 Hindi',
        'btn_colombian': '🇨🇴 Colombiano',
        'btn_indonesian': '🇮🇩 Indonesio',
        'btn_brazilian': '🇧🇷 Brasileiro',
        'language_set_en': '✅ Ingles selecionado. (Padrao)',
        'language_set_ar': '✅ Arabe selecionado. As mensagens aparecerao em arabe.',
        'language_set_fa': '✅ Persa selecionado. As mensagens aparecerao em persa.',
        'language_set_hi': '✅ Hindi selecionado. As mensagens aparecerao em hindi.',
        'language_set_es': '✅ Espanhol colombiano selecionado. As mensagens aparecerao em espanhol.',
        'language_set_id': '✅ Indonesio selecionado. As mensagens aparecerao em indonesio.',
        'language_set_pt': '✅ Portugues brasileiro selecionado. As mensagens aparecerao em portugues.',
        'btn_back': '🔙 Voltar',
        'btn_back_to_menu': '🔙 Voltar ao menu',
        'btn_back_to_main_menu': '🏠 Voltar ao menu principal',
        'product_title': '<b>🛍️ O que voce quer?</b>',
        'product_desc_1': '<b>Selecione uma categoria abaixo 👇</b>',
        'product_desc_2': '🎮 <b>Conta:</b> Comprar contas de jogo',
        'product_desc_3': '🔧 <b>Hacks:</b> Ver ferramentas e pacotes premium',
        'btn_account': '🎮 Conta',
        'btn_hackes': '🔧 Hacks',
        'account_title': '<b>🎮 Contas de jogo</b>',
        'account_desc': '<b>Escolha o tipo de conta abaixo 👇</b>\nCompre contas premium com moedas e recursos.',
        'hackes_title': '<b>🔧 Categorias de hacks</b>',
        'hackes_desc': '<b>Selecione uma categoria abaixo 👇</b>\nEscolha seu jogo e explore ferramentas e pacotes premium.',
        'no_resellers': '❌ Nenhum revendedor encontrado.',
        'trusted_sellers_title': '⭐ <b>Vendedores confiaveis</b>',
        'trusted_sellers_footer': '📞 Fale com qualquer vendedor para comprar!',
        'help_title': '<b>🛠 Precisa de ajuda?</b>',
        'help_purchase_error_title': '<b>⚠ Erro na compra</b>',
        'help_purchase_error_body': 'Se voce estiver com algum erro durante a compra.',
        'help_apk_title': '<b>📦 Link APK</b>',
        'help_apk_body': 'Se comprou algum hack e nao recebeu o link APK.',
        'help_any_title': '<b>🆘 Qualquer tipo de ajuda</b>',
        'help_any_body': 'Clique no botao abaixo para falar com o suporte do admin.',
        'btn_help_short': '🆘 Ajuda',
        'profile_title': '<b>👤 Meu perfil</b>',
        'profile_name': '<b>👤 Nome:</b> {name}',
        'profile_username': '<b>💻 Usuario:</b> @{username}',
        'profile_member_since': '<b>📅 Membro desde:</b> {date}',
        'btn_purchase_history': '📜 Historico de compras',
        'add_balance_title': '<b>╔════════════════════╗</b>\n<b>   CENTRAL DE SALDO</b>\n<b>╚════════════════════╝</b>',
        'add_balance_1': '<b>Quer adicionar saldo 💰</b>',
        'add_balance_2': '<b>Copie seu ID de usuario e toque em Depositar abaixo 👇</b>',
        'add_balance_3': '<b>Seu ID:</b>',
        'add_balance_4': '<b>Depois do pagamento, envie o print para o admin.</b>',
        'btn_deposit_now': '💳 Depositar agora',
        'btn_contact_admin': '💬 Contatar admin',
        'btn_refresh': '🔄 Atualizar',
        'history_empty': 'Nenhum historico de compra encontrado.',
        'history_title': '<b>🕓 Seu historico de compras:</b>',
        'history_page': '<b>Pagina {page}/{total}</b>',
        'history_product': '<b>📦 Produto:</b> {product}',
        'history_duration': '<b>⏳ Duracao:</b> {duration}',
        'history_key': '<b>🔑 Chave:</b> <code>{purchase_key}</code>',
        'history_status_expired': '<b>📅 Status:</b> Expirado ❌',
        'history_status_active': '<b>📅 Status:</b> Ativo ✅',
        'history_expired_on': '<i>Expirou em: {date}</i>',
        'history_expires_on': '<i>Expira em: {date}</i>',
        'btn_previous': '⬅️ Anterior',
        'btn_next': 'Proximo ➡️',
        'confirm_sure': '<b>📝 Tem certeza da compra? 🫆</b>',
        'confirm_separator': '<b>--------------------------------------</b>',
        'confirm_note': '<b>Por favor note📣:</b>',
        'confirm_no_return': '<b>A chave nao pode ser devolvida apos a compra!</b>',
        'confirm_your_balance': '<b>💰 Seu saldo:</b> ${balance}',
        'confirm_price': '<b>💰 Preco:</b> ${price}',
        'confirm_stock': '<b>📦 Estoque:</b> {stock}',
        'confirm_stock_available': '<b>📦 Estoque: Disponivel</b>',
        'btn_confirm': '✅ Confirmar',
        'btn_cancel': '❌ Cancelar',
        'out_of_stock_title': '❌ Produto sem estoque',
        'out_of_stock_product': '🐍 Produto: {product}',
        'out_of_stock_duration': '⏳ Duracao: {duration}',
        'out_of_stock_footer': '📦 Estoque disponivel: 0\n\nTente novamente mais tarde.',
        'not_vip_msg': '❌ Voce nao e VIP. Os precos sao visiveis apenas para usuarios VIP.',
        'unknown_product': 'Produto desconhecido.',
        'out_of_stock_error': '❌ Desculpe, o produto ficou sem estoque.',
        'insufficient_balance_title': '❌ Saldo insuficiente',
        'insufficient_balance_body': 'Seu saldo esta muito baixo para concluir esta compra.\n\nAdicione fundos e tente novamente.',
        'success_title': '<b>✅ Compra concluida!</b>',
        'success_product': '<b>📦 Produto:</b> {product}',
        'success_duration': '<b>⏳ Duracao:</b> {duration}',
        'success_remaining': '<b>💰 Saldo restante:</b> {balance}$',
        'success_key': '<b>🔑 Sua chave:</b> <code>{purchase_key}</code>',
        'success_enjoy': '<b>Aproveite seu acesso premium 🚀</b>',
        'account_not_available_title': '❌ Conta indisponivel',
        'account_not_available_body': 'Desculpe, nao ha contas disponiveis no momento.\nFale com o admin ou tente mais tarde.',
        'success_8bp_product': '🎱 <b>Produto:</b> {product}',
        'success_8bp_price': '💰 <b>Preco:</b> ${price}',
        'success_8bp_remaining': '💳 <b>Saldo restante:</b> ${balance}',
        'success_8bp_account_header': '          ✓ <b>Detalhes da conta</b>',
        'success_8bp_gmail': '📥 <b>Gmail:</b> {gmail}',
        'success_8bp_password': '🔐 <b>Senha:</b> {password}',
        'insuf_price': '💰 <b>Preco:</b> ${price}',
        'insuf_your_balance': '💳 <b>Seu saldo:</b> ${balance}',
        'insuf_shortfall': '📊 <b>Faltante:</b> ${shortfall}',
        'insuf_footer': 'Por favor adicione saldo na sua conta.',
    }
}
...
async def choose_language(update: Update, context: CallbackContext) -> None:
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(t(user_id, 'btn_brazilian'), callback_data='set_lang_pt')],
        [InlineKeyboardButton(t(user_id, 'btn_back'), callback_data='back_to_menu')],
    ])
...
async def set_language_brazilian(update: Update, context: CallbackContext) -> None:
    query = update.callback_query
    await query.answer(t(query.from_user.id, 'language_set_pt'), show_alert=False)
    set_user_language(query.from_user.id, 'pt')
    await back_to_menu(update, context)
